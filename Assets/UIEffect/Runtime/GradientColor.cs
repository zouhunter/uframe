...
{
    [AddComponentMenu("UFrame/UIEffect/GradientColor")]
    public class GradientColor : BaseMeshEffect
    {
        ...
        protected UiEffectListPool<UIVertex> m_pool = new UiEffectListPool<UIVertex>();
        public override void ModifyMesh(VertexHelper vh)
        {
            ...
            List<UIVertex> vList = m_pool.Get();
