...
namespace UFrame.BridgeUI.Editors
{
    public class GraphListDrawer : ReorderListDrawer
    {
        ...
        {
            var rect = GUILayoutUtility.GetRect(BridgeUI.Editors.BridgeEditorUtility.currentViewWidth, EditorGUIUtility.singleLineHeight);
        ...
        {
            var prop = property.GetArrayElementAtIndex(index);
            var height = EditorGUI.GetPropertyHeight(prop, null, true) + BridgeUI.Editors.BridgeEditorUtility.padding * 2;
            return height;
        }
