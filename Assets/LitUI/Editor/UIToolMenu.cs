...
{
    public class UGUIToolMenu
    {
        [MenuItem("GameObject/Weli_UGUI/AnchorsToCorners", priority = 0, validate = false)]
        ...
        [MenuItem("GameObject/Weli_UGUI/CornersToAnchors", priority = 0, validate = false)]
        ...
        [MenuItem("GameObject/Weli_UGUI/MirrorHorizontallyAnchors", priority = 0, validate = false)]
        public static void MirrorHorizontallyAnchors()
        {
            MirrorHorizontally(false);
        }
        [MenuItem("GameObject/Weli_UGUI/MirrorHorizontallyParent", priority = 0, validate = false)]
        ...
        [MenuItem("GameObject/Weli_UGUI/MirrorVerticallyAnchors", priority = 0, validate = false)]
        public static void MirrorVerticallyAnchors()
        {
            MirrorVertically(false);
        }
        [MenuItem("GameObject/Weli_UGUI/MirrorVerticallyParent", priority = 0, validate = false)]
