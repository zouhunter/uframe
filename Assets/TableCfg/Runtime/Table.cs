...
namespace UFrame.TableCfg
{
    ...
    {
        private SortedDictionary<Key, Row> m_keyRowMap;

        public SortedDictionary<Key, Row> KeyRowMap { get => m_keyRowMap; private set => m_keyRowMap = value; }

        public Table()
        {
            m_keyRowMap = new SortedDictionary<Key, Row>();
        }
        ...
        public SortedDictionary<Key, Row>.Enumerator GetKeyDictionaryEnumerator()
        {
    ...
    {
        private SortedDictionary<Key1, SortedDictionary<Key2, Row>> m_keyRowMap;
        public SortedDictionary<Key1, SortedDictionary<Key2, Row>> KeyRowMap
        {
            get
            {
                return m_keyRowMap;
        ...
        public Table()
        {
            m_keyRowMap = new SortedDictionary<Key1, SortedDictionary<Key2, Row>>();
        }
        ...
        public SortedDictionary<Key1, SortedDictionary<Key2, Row>>.Enumerator GetKeyDictionaryEnumerator()
        {
            return m_keyRowMap.GetEnumerator();
        }
        ...
        protected override void OnAddRow(Row row)
        {
            ...
            {
                m_keyRowMap[row.K1] = new SortedDictionary<Key2, Row>();
            }
        ...
        public SortedDictionary<Key2, Row> GetByKey(Key1 key1)
        {
    ...
    {
        private SortedDictionary<Key1, SortedDictionary<Key2, SortedDictionary<Key3, Row>>> m_keyRowMap;
        public SortedDictionary<Key1, SortedDictionary<Key2, SortedDictionary<Key3, Row>>> KeyRowMap
        {
            get
            {
                return m_keyRowMap;
        ...
        public Table()
        {
            m_keyRowMap = new SortedDictionary<Key1, SortedDictionary<Key2, SortedDictionary<Key3, Row>>>();
        }
        ...
        public SortedDictionary<Key1, SortedDictionary<Key2, SortedDictionary<Key3, Row>>>.Enumerator GetKeyDictionaryEnumerator()
        {
            return m_keyRowMap.GetEnumerator();
        }
        ...
        protected override void OnAddRow(Row row)
        {
            ...
            if (!m_keyRowMap.TryGetValue(row.K1, out var dic))
            {
                dic = m_keyRowMap[row.K1] = new SortedDictionary<Key2, SortedDictionary<Key3, Row>>();
            }
            if (!dic.TryGetValue(row.K2, out var dic2))
            {
                dic2 = m_keyRowMap[row.K1][row.K2] = new SortedDictionary<Key3, Row>();
            }
        ...
        public SortedDictionary<Key2, SortedDictionary<Key3,Row>> GetByKey(Key1 key1)
        {
            if (key1 != null && m_keyRowMap.TryGetValue(key1, out var dic))
            {
                return dic;
        ...
        public SortedDictionary<Key3, Row> GetByKey(Key1 key1,Key2 key2)
        {
            if (key1 != null && key2 != null && m_keyRowMap.TryGetValue(key1, out var dic))
            {
