...
namespace UFrame.Editors
{
    public class ObjectHolder
    {
        ...
        public Texture Preview
        {
            ...
            {
                if (_preview == null)
                    _preview = WidgetUtility.CreatePreview(widgetType, new WidgetItem(name, _preview, spriteDic));
                return _preview;
            }
        }
        ...
        public Dictionary<string, Sprite> spriteDic
        {
            ...
            {
                if (_textures == null)
                    _textures = WidgetUtility.LoadTextures(json, assetDir);
                return _textures;
            }
        }
        ...
        public ObjectHolder(Texture texture)
        {
        ...
        public GameObject CreateInstence()
        {
            ...
            var info = new WidgetItem(name, Preview, spriteDic);
