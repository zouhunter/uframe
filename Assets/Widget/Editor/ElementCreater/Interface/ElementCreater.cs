    ...
    public abstract class DefultElementCreater : ElementCreater
    {
        ...
        public override GameObject CreateOrCharge(WidgetItem info)
        {
            ...
            if (oldBtn != null)
            {
                ...
                ChargeWidgetInfo(oldBtn, info,false);
            ...
            else
            {
                ...
                if(instence)
                {
                    ...
                    ChargeWidgetInfo(instence, info,true);
        ...
        protected abstract void ChargeWidgetInfo(Component component, WidgetItem info,bool newCreated);
    }
