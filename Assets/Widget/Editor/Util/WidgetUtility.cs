...
namespace UFrame.Editors
{
    public static class WidgetUtility
    {
        ...
        //打开窗口的猜到，可自定义
        public const string Menu_widgetWindow = "Window/UFrame/UI-Editor/WidgetView";
        ...
        public static ObjectHolder[] LoadAllObjectHolders(string spritePath)
        {
        ...
        private static List<ObjectHolder> LoadAllSprites(string fullpath)
        {
            ...
            foreach (var spritepath in spritepaths)
            {
                ...
                if (texture != null)
                {
                    var holder = new ObjectHolder(texture);
                    holders.Add(holder);
                }
            }
            return holders;
        ...
        public static void MakeTextureReadable(Texture texture, bool changeToTexture)
        {
        ...
        {
            IElementCreater creater = GetCreater(type);
            if (creater is IElementPreview)
            {
                return (creater as IElementPreview).GetPreviewTexture();
            }
        ...
        private static IElementCreater GetCreater(WidgetType type)
        {
            ...
            {
                var typeName = "UFrame.Editors." + type.ToString() + "Creater";
        ...
        public static Texture GetPreviewFromSpriteList(List<Sprite> list)
        {
            ...
            foreach (var sprite in list)
            {
                ...
                else
                {
                    ...
                    MakeTextureReadable(current, false);
