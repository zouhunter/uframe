...
namespace UFrame.HTN
{
    public class NTreeUtil
    {
        ...
        static NTreeUtil util;
        private Dictionary<BaseNode, Texture2D> _nodeTextures = new Dictionary<BaseNode, Texture2D>();
        private Dictionary<NTree, Texture2D> _treeTextures = new Dictionary<NTree, Texture2D>();
        ...
        /// 双击子树
        /// </summary>
        public static bool DrawSubTree(Rect iconRect, NTree tree)
        {
            if (!tree)
                return false;
        ...
        private static Texture2D FindTreeIcon(NTree tree)
        {
        ...
        public static Texture2D FindNodeIconFromNode(BaseNode node)
        {
            ...
            return IconCacheUtil.GetTextureByGUID(util._actionIcon);
        }
    }
}
