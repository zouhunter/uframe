...
{
    public class NTreeNodeView
    {
        private int _windowId;
        private NTree _tree;
        private TaskInfo _rootInfo;
        private TaskInfo _info;
        private TaskInfo _parentInfo;
        private Vector2 _position;
        private Rect _rect;
        public ref Rect Rect => ref _rect;
        public TaskInfo Info => _info;
        ...
        public Action<NTreeNodeView> onActive { get; set; }
        ...
        public NTreeNodeView(NTree bTree, TaskInfo rootInfo, TaskInfo info, Vector2 pos)
        {
            this._tree = bTree;
        ...
        private TaskInfo FindParentNode(TaskInfo info, TaskInfo match)
        {
            ...
            else
            {
                ...
                {
                    var parent = FindParentNode(subInfo as TaskInfo, match);
                    if (parent != null)
                    {
                        return parent;
                    }
