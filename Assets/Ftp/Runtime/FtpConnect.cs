...
namespace UFrame.Ftp
{
    public class FtpConnect
    {
        ...
        public FtpConnect(string host, string userId, string password)
        ...
        public FtpConnect(string host, string userId, string password, int port, IWebProxy proxy, bool enableSsl, bool useBinary, bool usePassive)
        {
            this.userId = userId;
        ...
        public void ChangeDirectory(string dirName)
        {
            ...
            {
                result = "/" + dirName.TrimStart('/').TrimEnd('/') + "/";
            }
