...
namespace UFrame
{
    public abstract class Adapter<AgentContainer> : AdapterBase where AgentContainer : Adapter<AgentContainer>, new()
    {
    ...
    public abstract class Adapter<AgentContainer, IAgent> : UFrame.AdapterBase
    where AgentContainer : Adapter<AgentContainer, IAgent>, new()
    {
        protected virtual BaseGameManage Manage => BaseGameManage.Single;
        protected static object m_locker = new object();
        ...
        protected override void OnInitialize()
        {
            if (Instance != null && Instance is UFrame.AdapterBase)
            {
                (Instance as UFrame.AdapterBase).Initialize();
            }
        }
        ...
        protected override void OnRecover()
        {
            if (Instance != null && Instance is UFrame.AdapterBase)
            {
                (Instance as UFrame.AdapterBase).Recover();
            }
        }
        protected override void OnAfterRecover()
        {
    ...
    public abstract class Adapter<AgentContainer, IAgent, Agent> : UFrame.AdapterBase
    where AgentContainer : Adapter<AgentContainer, IAgent, Agent>, new()
    where Agent : IAgent
    {
        protected virtual BaseGameManage Manage => BaseGameManage.Single;
        protected static object m_locker = new object();
