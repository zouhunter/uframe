...
namespace UFrame.DressAB.Editors
{
    ...
    public class AddressDefineObjectEditor : Editor
    {
        ...
        private void DrawListElement(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            var singleRect = new Rect(rect.x + rect.width - 20, rect.y + 4, 20, rect.height + 4);
            info.single = EditorGUI.Toggle(singleRect, info.single, EditorStyles.radioButton);
            ...
            var nameRect = new Rect(rect.x + rect.width * 0.7f, rect.y + 2, rect.width * 0.3f - 20, rect.height - 4);
            if (!alive)
            {
                GUI.color = Color.red;
