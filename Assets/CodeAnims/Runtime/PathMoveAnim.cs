...
{
    [AddComponentMenu("UFrame/CodeAnimation/PathMoveAnim")]
    public class PathMoveAnim : CodeAnimBase
    {
        ...
        public override void Play()
        {
            if (m_tweenPath == null)
            {
                ...
                m_tweenPath = new TweenPath(m_target, paths.ToArray(), true, m_dureation);
