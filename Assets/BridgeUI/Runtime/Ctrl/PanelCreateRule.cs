...
namespace UFrame.BridgeUI
{
    public class PanelCreateRule : IPanelCreater
    {
        ...
        protected UILoader bundleLoader;

        public PanelCreateRule(UILoader bundlePanelCreater)
        {
        ...
        public void CreatePanel(UIInfoBase itemInfo, UnityEngine.Events.UnityAction<GameObject> onCreate)
        {
            ...
            if (!_loadingKeys.Contains(itemInfo.IDName))
            {
                ...
                else if (bInfo != null)
                {
                    ...
                    {
                        bundleLoader.LoadAssetAsync(bInfo.bundleName, bInfo.panelName, (x) =>
                        {
                            if (x != null)
                            {
        ...
        public void ReleasePanel(string panel)
        {
            if (bundleLoader != null)
            {
                bundleLoader.Release(panel);
            }
        }
    }
