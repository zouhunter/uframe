...
namespace UFrame.BridgeUI.Editors
{
    ...
    public abstract class ViewCoderExecuter: IViewCoderExecuter
    {
        ...
        protected FieldInfo[] subReferences { get { return viewCoder.subReferences; } }
        protected ReferenceItem[] referenceItems => viewCoder.referenceItems;
        
        protected MonoBehaviour target { get { return viewCoder.target; } }
