...
namespace UFrame.BridgeUI
{
    public class ControlWithIDListDrawer
    {
        ...
        protected virtual void InitReorderList()
        {
            ...
            reorderList.elementHeight = EditorGUIUtility.singleLineHeight + BridgeUI.Editors.BridgeEditorUtility.padding * 2;
        ...
        {
            rect = BridgeUI.Editors.BridgeEditorUtility.DrawBoxRect(rect, "");
