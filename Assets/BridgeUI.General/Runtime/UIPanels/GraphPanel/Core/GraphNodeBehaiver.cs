...
namespace UFrame.BridgeUI
{
    ...
    {
        [SerializeField]
        protected Button m_addItem;//添加子项
        [SerializeField]
        protected Button m_insert;//插入节点
        [SerializeField]
        protected Button m_destory;//删除子项
        [SerializeField]
        protected InputField info;//节点名称
        [SerializeField]
        protected Toggle m_auto;
        ...
        protected int deepth { get; set; }

        protected System.Func<int, Transform, GraphNodeBehaiver> GetInstence { get; set; }
        ...
        protected void SetAsChildItem(GraphNodeBehaiver instence)
        {
            if (instence != null)
            {
        ...
        protected void InstanceChildItems(SelectorData[] datas)
        {
