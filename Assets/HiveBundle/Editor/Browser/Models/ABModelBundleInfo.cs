...
namespace UFrame.HiveBundle.Models
{
    ...
    {   
        ...
        internal BundleTreeItem(BundleInfo b, int depth, Texture2D iconTexture) : base(b.nameHashCode, depth, b.displayName)
        {
            ...
            enable = Model.DataSource.CheckBundleEnable(b.m_Name.bundleName);
        }
    ...
    internal abstract class BundleInfo
    {
        ...
        internal virtual void HandleEnable(bool enable)
        {
            Debug.Log("mark bundle enable:" + enable);
        }
    ...
    internal class BundleDataInfo : BundleInfo
    {
        ...
        ~BundleDataInfo()
        {
            ...
            {
                Models.Model.UnRegisterAsset(asset, m_Name.fullNativeName);
            }
        }
        ...
        internal override void HandleEnable(bool enable)
        {
            Model.MarkAssetEnable(m_Name.fullNativeName,enable);
        }
        ...
        internal override void RefreshAssetList()
        {
            ...
            var assets = Models.Model.DataSource.GetAssetPathsFromAssetBundle(m_Name.fullNativeName);
        ...
        private void GatherDependencies(AssetInfo asset, string parentBundle = "")
        {
            ...
            foreach (var ai in deps)
            {
                ...
                var bundleName = Models.Model.DataSource.GetImplicitAssetBundleName(ai.fullAssetName);
    ...
    internal abstract class BundleFolderInfo : BundleInfo
    {
        ...
        public bool CheckEnableDeepth()
        {
            foreach (var pair in m_Children)
            {
                if(pair.Value is BundleFolderInfo folderInfo)
                {
                    if (folderInfo.CheckEnableDeepth())
                        return true;
                }
                else if (Model.DataSource.CheckBundleEnable(pair.Value.m_Name.bundleName))
                {
                    return true;
                }
            }
        ...
        internal override void HandleEnable(bool enable)
        {
            foreach (var child in m_Children)
            {
                child.Value.HandleEnable(enable);
            }
        }
