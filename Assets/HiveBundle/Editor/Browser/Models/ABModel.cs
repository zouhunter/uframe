...
namespace UFrame.HiveBundle.Models
{
    ...
    public static class Model
    {
        ...
        private static AssetBundleDataSource.ABDataSource s_DataSource;
        ...
        ///  
        /// </summary>
        public static AssetBundleDataSource.ABDataSource DataSource
        {
            get
            {
                if (s_DataSource == null)
                {
                    s_DataSource = new AssetBundleDataSource.HiveBundleDataSource ();
                }
                return s_DataSource;
            }
        ...
        internal static void HandleBundleEnable(IEnumerable<BundleInfo> bundles,bool enable)
        {
            foreach (var bundle in bundles)
            {
                bundle.HandleEnable(enable);
            }
        }
        ...
        internal static void MarkAssetEnable(string bundlePath, bool enable)
        {
            Model.DataSource.MarkBundleEnable(bundlePath, enable);
        }
