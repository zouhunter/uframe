...
namespace UFrame.HiveBundle.AssetBundleDataSource
{
    ...
    public partial interface ABDataSource
    {
        ...
        void MarkBundleEnable(string bundlePath, bool enable);
        /// <summary>
        /// 检查资源包enable
        /// </summary>
        /// <param name="bundleName"></param>
        /// <returns></returns>
        bool CheckBundleEnable(string bundlePath);
        /// <summary>
        ...
        /// </summary>
        /// <param name="v"></param>
        void SplitFolderBundles(string bundlePath);
        /// <summary>
        /// 合并资源包
        /// </summary>
        /// <param name="bundlePath"></param>
        void MergeFolderBundles(string bundlePath);
        /// <summary>
        /// 文件夹分包
        /// </summary>
        /// <param name="path"></param>
        void SetBundleNameRule(string path, NameRule rule);
    }
}
