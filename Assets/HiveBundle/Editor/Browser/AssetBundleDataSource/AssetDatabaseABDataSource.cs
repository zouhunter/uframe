...
namespace UFrame.HiveBundle.AssetBundleDataSource
{
    internal class AssetDatabaseABDataSource : ABDataSource
    {
        ...
        public void SplitFolderBundles(string folder)
        {
        }
        ...
        public void MarkBundleEnable(string bundleName, bool enable)
        {

        }

        public bool CheckBundleEnable(string bundleName)
        {
            return true;
        }

        public void SetBundleNameRule(string path, NameRule rule)
        {
        }
    }
}
